...
#sound
back_sound = pygame.mixer.Sound("Assets/Sound/frst.mp3")
click_sound=pygame.mixer.Sound("Assets/Sound/click.mp3")
type_sound=pygame.mixer.Sound("Assets/Sound/type.mp3")
error_sound=pygame.mixer.Sound("Assets/Sound/error.mp3")
correct_sound=pygame.mixer.Sound("Assets/Sound/correct.mp3")
wrong_sound=pygame.mixer.Sound("Assets/Sound/wrong.mp3")

pygame.mixer.music.load("Assets/Sound/frst.mp3")
